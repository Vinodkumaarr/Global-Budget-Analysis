...
def generate_statistical_forecast(country_name, target_year=2035, degree=2):
    """
    Fits an n-degree polynomial trend line to historical data using pure NumPy linear algebra
    and projects it to a future year configuration.
    """
